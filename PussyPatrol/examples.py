import breeds_managers as bm
import identified_managers as im
import master_managers as mm
...
um.create_table_users()


##Creating a user called Stacy who spots 3 cats 2 with pics and changes her username to Stacy's_mum.

um.new_user("Stacy","123")
a = sm.new_sightings(54.7732,-1.5764, 123456789,"Cat","Stacy") ##This return Aisd for ease
pm.new_picture(a,"Cat.jpeg")
b = sm.new_sightings(54.7732,-1.5764, 123456798,"Cat","Stacy")
pm.new_picture(b,"catttt.jpeg")
sm.new_sightings(54.7732,-1.5764, 123456989,"Cat","Stacy")
...
sm.new_sightings(54.7732,-1.5764, 123456790,"Cat","Karen")
...
new_sightings(54.7732,-1.5764, 123456989,"Mouse","Dachode")

##stop! Look! HOT PUSS IN YOUR AREA
hot_puss_in_your_area(54.773, -1.5764 ,diagDistKm=5,dateTime=None,dayPrevious=None)
